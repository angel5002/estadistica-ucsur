...
const FALLBACK_SEMANAS = [
  {
    ...
    cuestionario:[
      { estudianteId:2, numero:1, enunciado:'Clasifique la variable de acuerdo a su naturaleza y su medición: Tiempo de vida útil de un foco con filamento nuevo.', desarrollo:'', imagenes:['imgs/semanas/semana01/cuestionario/respuesta-1.jpeg'], tabla:null, grafico:null },
  ...
  },
  {
    ...
    cuestionario:[
      { estudianteId:2, numero:1, contexto:'Se ha observado la variable X = "Saldo (en Euros)" de 400 cuentas corrientes de clientes con edades comprendidas entre 18 y 25 años. El siguiente gráfico recoge la distribución de porcentajes acumulados de esta variable.', imagenesEnunciado:['imgs/semanas/semana02/cuestionario/enunciados/enunciado-1.jpeg'], preguntas:'Indique el número de cuentas con un saldo de:\na) Menor de 110 Euros.\nb) Mínimo 90 Euros.', desarrollo:'', imagenes:['imgs/semanas/semana02/cuestionario/respuesta-1.jpeg'], tabla:null, grafico:null },
      { estudianteId:2, numero:2, contexto:'La empresa de investigación de mercados Alpha Datum S. A. realizó un estudio para evaluar la caída de la Bolsa de Valores de Lima (BVL) en las Administradoras de Fondos de Pensiones (AFP). En este estudio, se tomó una muestra de 50 afiliados de entre 25 y 35 años seleccionados al azar en Lima y se registraron los datos referentes a sus ingresos mensuales (en cientos de soles).', imagenesEnunciado:['imgs/semanas/semana02/cuestionario/enunciados/enunciado-2.jpeg'], preguntas:'¿Qué porcentaje de los afiliados tienen ingresos entre 151 mil y 349 mil soles?', desarrollo:'', imagenes:['imgs/semanas/semana02/cuestionario/respuesta-2.jpeg'], tabla:null, grafico:null },
      { estudianteId:2, numero:3, contexto:'Los ingresos mensuales (en miles de dólares) que lograron 40 empresas de la ciudad de Lima se resumen en la siguiente tabla de frecuencias con 6 intervalos de amplitud constante:', imagenesEnunciado:['imgs/semanas/semana02/cuestionario/enunciados/enunciado-3.jpeg'], preguntas:'¿Qué porcentaje de empresas tuvieron ingresos de por lo menos 40 000 dólares?', desarrollo:'', imagenes:['imgs/semanas/semana02/cuestionario/respuesta-3.jpeg'], tabla:null, grafico:null },
      { estudianteId:2, numero:4, contexto:'El número de operaciones bancarias virtuales que realizan 50 clientes de un banco durante una semana viene dado por la siguiente serie:', imagenesEnunciado:['imgs/semanas/semana02/cuestionario/enunciados/enunciado-4.jpeg'], preguntas:'¿Cuántos clientes realizan máximo 3 operaciones?\n¿Qué porcentaje de los clientes realizan menos de 3 operaciones?', desarrollo:'', imagenes:['imgs/semanas/semana02/cuestionario/respuesta-4.jpeg'], tabla:null, grafico:null },
      { estudianteId:2, numero:5, contexto:'La empresa de investigación de mercados Alpha Datum S. A. realizó un estudio para evaluar la caída de la Bolsa de Valores de Lima (BVL) en las Administradoras de Fondos de Pensiones (AFP). En este estudio, se tomó una muestra de 50 afiliados de entre 25 y 35 años seleccionados al azar en Lima y se registraron los datos referentes a sus ingresos mensuales (en cientos de soles).', imagenesEnunciado:['imgs/semanas/semana02/cuestionario/enunciados/enunciado-5.jpeg'], preguntas:'¿Calcule la amplitud y la cantidad de intervalos?', desarrollo:'', imagenes:['imgs/semanas/semana02/cuestionario/respuesta-5.jpeg'], tabla:null, grafico:null },
    ],
    ficha:[
      { estudianteId:5, numero:1, contexto:'Se realizó un estudio a 40 personas que visitan frecuentemente el centro histórico de Lima para conocer su estado civil. Los resultados obtenidos fueron los siguientes (C=Casado, S=Soltero, V=Viudo, D=Divorciado):', imagenesEnunciado:['imgs/semanas/semana02/ficha/enunciados/enunciado-1.jpeg'], preguntas:'a. ¿Qué tipo de variable es el estado civil?\nb. Construye la tabla de distribución de frecuencias absolutas, relativas y porcentuales.\nc. Elabora un gráfico circular (o de sectores) para presentar estos datos.\nd. ¿Cuál es la categoría con mayor frecuencia?\ne. ¿Cuántas personas se encuentran casadas?\nf. ¿Qué porcentaje de personas son viudas?\ng. ¿Qué porcentaje de las personas encuestadas no están solteras?', desarrollo:'', imagenes:['imgs/semanas/semana02/ficha/respuesta-1.jpeg'], tabla:null, grafico:null },
      { estudianteId:5, numero:2, contexto:'A continuación, se muestra el registro del número de cursos que llevan los estudiantes que trabajan durante el ciclo 2023-2:', imagenesEnunciado:['imgs/semanas/semana02/ficha/enunciados/enunciado-2.jpeg'], preguntas:'a. Construya la tabla de distribución de frecuencias adecuada y coloque el título apropiado.\nb. Realice la siguiente interpretación F₂ y h₃%.\nc. Dibuje el gráfico más adecuado para esta variable (gráfico de bastones o barras).\nd. ¿Qué porcentaje de estudiantes que trabajan llevan cuatro cursos durante el ciclo 2023-2?\ne. ¿Cuántos estudiantes que trabajan llevan como mínimo seis cursos durante el ciclo 2023-2?\nf. ¿Cuántos estudiantes que trabajan llevan a lo más cinco cursos durante el ciclo 2023-2?', desarrollo:'', imagenes:['imgs/semanas/semana02/ficha/respuesta-2-1.jpeg','imgs/semanas/semana02/ficha/respuesta-2-2.jpeg'], tabla:null, grafico:null },
      { estudianteId:5, numero:3, contexto:'Complete la siguiente distribución de frecuencias:', imagenesEnunciado:['imgs/semanas/semana02/ficha/enunciados/enunciado-3.jpeg'], preguntas:'', desarrollo:'', imagenes:['imgs/semanas/semana02/ficha/respuesta-3.jpeg'], tabla:null, grafico:null },
      { estudianteId:5, numero:4, contexto:'Los siguientes datos son las remuneraciones mensuales de 40 operadores de call center que incluye su sueldo básico y sus comisiones:', imagenesEnunciado:['imgs/semanas/semana02/ficha/enunciados/enunciado-4.jpeg'], preguntas:'a. Construya la distribución de frecuencias agrupando los datos.\nb. Interpretar f₂, F₃, h₂%, H₂%.', desarrollo:'', imagenes:['imgs/semanas/semana02/ficha/respuesta-4.jpeg'], tabla:null, grafico:null },
      { estudianteId:5, numero:5, contexto:'En un proceso de selección laboral se registra el tiempo que demoran en realizar un examen de aptitud a un grupo de 20 postulantes. A continuación, se muestran los datos en horas:', imagenesEnunciado:['imgs/semanas/semana02/ficha/enunciados/enunciado-5.jpeg'], preguntas:'Se solicita:\na. Identificar la unidad de análisis y la variable de estudio.\nb. Construir una distribución de frecuencia utilizando la regla de Sturges para determinar el número de intervalos y coloque el título apropiado.\nc. Interpretar f₃, H₂%.\nd. ¿Qué porcentaje de postulantes demoraron en realizar el examen de aptitud de por lo menos 1,37 horas?\ne. ¿Cuántos postulantes demoraron en realizar el examen de aptitud menos de 1,46 horas?', desarrollo:'', imagenes:['imgs/semanas/semana02/ficha/respuesta-5.jpeg'], tabla:null, grafico:null },
      { estudianteId:5, numero:6, contexto:'En el centro de salud mental comunitario ubicado en la zona de Bayóvar, se está ejecutando el Proyecto "Bienestar Emocional", cuyo objetivo es evaluar los niveles de ansiedad autoevaluada en una muestra de 20 adolescentes, utilizando una escala estandarizada que va de 0 a 30. Los puntajes obtenidos son los siguientes:', imagenesEnunciado:['imgs/semanas/semana02/ficha/enunciados/enunciado-6.jpeg'], preguntas:'Se solicita:\na. Organiza los datos en una tabla de frecuencias utilizando la regla de Sturges.\nb. Interpreta las siguientes frecuencias: F₂ y H₃%.\nc. Si se considera un puntaje mínimo de 13 como indicador de ansiedad significativa, ¿qué porcentaje de adolescentes presenta esta condición?\nd. Si se desea identificar al 25% de los adolescentes con los niveles de ansiedad más bajos para un estudio de factores protectores, ¿hasta qué puntaje se incluirían en este grupo?\ne. Si se define un rango de ansiedad "leve" con un puntaje mínimo de 7 pero menos de 17, ¿qué porcentaje de adolescentes se encuentra en este rango?', desarrollo:'', imagenes:['imgs/semanas/semana02/ficha/respuesta-6-1.jpeg','imgs/semanas/semana02/ficha/respuesta-6-2.jpeg'], tabla:null, grafico:null },
      { estudianteId:5, numero:7, enunciado:'Utilizando el SPSS:\na. Elaborar una tabla de frecuencias y su gráfico respectivo de los datos de las preguntas 1 y 2.\nb. Elaborar una tabla de frecuencias con intervalos y su gráfico respectivo de los datos de las preguntas 4, 5 y 6.', desarrollo:'', imagenes:['imgs/semanas/semana02/ficha/respuesta-7.jpeg'], tabla:null, grafico:null },
    ],
  },
