...
const FALLBACK_SEMANAS = [
  {
    ...
    cuestionario:[
      { estudianteId:1, numero:1, enunciado:'Clasifique la variable de acuerdo a su naturaleza y su medición: Tiempo de vida útil de un foco con filamento nuevo.', desarrollo:'', imagenes:['imgs/semanas/semana01/cuestionario/respuesta-1.jpg'], tabla:null, grafico:null },
      { estudianteId:2, numero:2, enunciado:'Clasifique la variable de acuerdo a su naturaleza y su medición: Calidad del servicio de atención: Excelente ( ) Bueno ( ) Regular ( ) Deficiente ( )', desarrollo:'', imagenes:['imgs/semanas/semana01/cuestionario/respuesta-2.jpg'], tabla:null, grafico:null },
      { estudianteId:3, numero:3, enunciado:'Clasifique la variable de acuerdo a su naturaleza y su medición: Número de DNI.', desarrollo:'', imagenes:['imgs/semanas/semana01/cuestionario/respuesta-3.jpg'], tabla:null, grafico:null },
      { estudianteId:4, numero:4, enunciado:'Clasifique la variable de acuerdo a su naturaleza y su medición: Niveles de estrés (leve, moderado, severo).', desarrollo:'', imagenes:['imgs/semanas/semana01/cuestionario/respuesta-4.jpg'], tabla:null, grafico:null },
      { estudianteId:5, numero:5, enunciado:'Clasifique la variable de acuerdo a su naturaleza y su medición: Ingreso mensual por la venta de las acciones durante un mes.', desarrollo:'', imagenes:['imgs/semanas/semana01/cuestionario/respuesta-5.jpg'], tabla:null, grafico:null },
    ],
    ficha:[
